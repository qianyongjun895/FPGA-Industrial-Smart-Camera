...
#include "ui_WRDRegSelectDataDialog.h"
#include "TaskHeaderGlobal.h"
#include "TaskStepGlobal.h"
#include "TaskRstGlobal.h"
#include "xmlInitGlobal.h"
#include "LinkDataGlobal.h"
WRDRegSelectDataDialog::WRDRegSelectDataDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::WRDRegSelectDataDialog)
{
    ui->setupUi(this);
    task_pre_index = 0;
    detail_pre_index = 0;
...
WRDRegSelectDataDialog::~WRDRegSelectDataDialog()
{
    delete ui;
}
void WRDRegSelectDataDialog::IniData()
{
    char taskName[40];
...
void WRDRegSelectDataDialog::InitTaskListTableWidget(int index, QString taskName)
{
...
void WRDRegSelectDataDialog::InitTaskResultListTableWidget(int index, QString taskResult)
{
...
void WRDRegSelectDataDialog::InitTaskDataListTableWidget(int index, QString taskResult)
{
...
void WRDRegSelectDataDialog::on_tableWidget_task_cellClicked(int row, int column)
{
    int curr_row = 0;
    char TaskResult[100];
...
void WRDRegSelectDataDialog::on_tableWidget_detail_cellClicked(int row, int column)
{
    char TaskResult[100];
    int curr_row = 0;
...
void WRDRegSelectDataDialog::on_tableWidget_data_cellClicked(int row, int column)
{
    ui->pushButton_OK->setEnabled(true);
}

void WRDRegSelectDataDialog::on_pushButton_OK_clicked()
{
...
void WRDRegSelectDataDialog::on_pushButton_Cancel_clicked()
{
    QDialog::reject();
}
