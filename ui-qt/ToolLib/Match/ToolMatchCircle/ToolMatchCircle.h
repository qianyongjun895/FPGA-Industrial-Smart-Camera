#ifndef TOOLMATCHCIRCLE_H
#define TOOLMATCHCIRCLE_H

#include "toolmatchcircle_global.h"
#include <QWidget>
#include "CircleWidget.h"
#include "ResolveRunData.h"
class TOOLMATCHCIRCLESHARED_EXPORT ToolMatchCircle
{
