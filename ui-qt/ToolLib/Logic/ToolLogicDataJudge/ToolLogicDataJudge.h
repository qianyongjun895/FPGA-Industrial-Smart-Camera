#ifndef TOOLLOGICDATAJUDGE_H
#define TOOLLOGICDATAJUDGE_H

#include "toollogicdatajudge_global.h"
#include <QWidget>
#include "../../BasicDefine.h"

class TOOLLOGICDATAJUDGESHARED_EXPORT ToolLogicDataJudge
{
