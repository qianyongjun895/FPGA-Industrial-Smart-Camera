#ifndef TOOLLOGICWORKOVER_H
#define TOOLLOGICWORKOVER_H

#include "toollogicworkover_global.h"
#include <QWidget>
#include "../../BasicDefine.h"

class TOOLLOGICWORKOVERSHARED_EXPORT ToolLogicWorkOver
{
