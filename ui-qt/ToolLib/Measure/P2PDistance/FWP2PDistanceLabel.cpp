...
FWP2PDistanceLabel::FWP2PDistanceLabel(QWidget *parent) : QLabel(parent)
{
    i_learn_result = 0;
...
/**
 * @brief FWP2PDistanceLabel::SetPoint1
 * @param point 点1坐标
 * @author dgq
 * @note 设置点一的坐标
 */
void FWP2PDistanceLabel::SetPoint1(QPoint point)
{
    m_point1 = point;
    update();
}
...
/**
 * @brief FWP2PDistanceLabel::SetPoint2
 * @param point 点2坐标
 * @author dgq
 * @note 设置点二的坐标
 */
void FWP2PDistanceLabel::SetPoint2(QPoint point)
{
    m_point2 = point;
    update();
}

void FWP2PDistanceLabel::SetSet_Parameter_To_RamFlag(int flag)
{
    i_learn_result = flag;
    update();
}
...
/**
 * @brief FWP2PDistanceLabel::paintEvent
 * @param e
 * @author dgq
 * @note 两点距离的osd绘制函数
 */
void FWP2PDistanceLabel::paintEvent(QPaintEvent *e)
{
    QLabel::paintEvent(e);
...
void FWP2PDistanceLabel::SetPenColor(void *pen_color)
{
