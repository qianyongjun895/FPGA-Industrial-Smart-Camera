...
class MultiRegDialog : public QDialog
{
    Q_OBJECT

public:
    explicit MultiRegDialog(QWidget *parent = 0);
    ~MultiRegDialog();
...
private:
    ...
    void AddMultiRegItem(MultiRegItem *item);
