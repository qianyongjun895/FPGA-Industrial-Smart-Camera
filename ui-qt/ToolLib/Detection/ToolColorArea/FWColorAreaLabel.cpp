...
FWColorAreaLabel::FWColorAreaLabel(QWidget *parent) : QLabel(parent)
{
    m_point = QPoint(-10,-10);
    m_pen_color = NULL;
}

FWColorAreaLabel::~FWColorAreaLabel()
{

}

void FWColorAreaLabel::SetOsdPoint(QPoint point)
{
    m_point = point;
    update();
}

void FWColorAreaLabel::paintEvent(QPaintEvent *e)
{
    QLabel::paintEvent(e);
...
void FWColorAreaLabel::SetPenColor(void *pen_color)
{
