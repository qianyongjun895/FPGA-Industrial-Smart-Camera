...
#include "ui_ModbusSelectDataDialog.h"
#include "TaskHeaderGlobal.h"
#include "TaskStepGlobal.h"
#include "xmlInitGlobal.h"
#include "LinkDataGlobal.h"
#include "TaskRstGlobal.h"
ModbusSelectDataDialog::ModbusSelectDataDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ModbusSelectDataDialog)
{
    ui->setupUi(this);
    task_pre_index = 0;
    detail_pre_index = 0;
...
ModbusSelectDataDialog::~ModbusSelectDataDialog()
{
    delete ui;
}

void ModbusSelectDataDialog::IniData()
{
    char taskName[40];
...
void ModbusSelectDataDialog::InitTaskListTableWidget(int index, QString taskName)
{
...
void ModbusSelectDataDialog::InitTaskResultListTableWidget(int index, QString taskResult)
{
...
void ModbusSelectDataDialog::InitTaskDataListTableWidget(int index, QString taskResult)
{
...
void ModbusSelectDataDialog::on_tableWidget_task_cellClicked(int row, int column)
{
    int curr_row = 0;
    char TaskResult[100];
...
void ModbusSelectDataDialog::on_tableWidget_detail_cellClicked(int row, int column)
{
    char TaskResult[100];
    int curr_row = 0;
...
void ModbusSelectDataDialog::on_tableWidget_data_cellClicked(int row, int column)
{
    ui->pushButton_OK->setEnabled(true);
}

void ModbusSelectDataDialog::on_pushButton_OK_clicked()
{
...
void ModbusSelectDataDialog::on_pushButton_Cancel_clicked()
{
    QDialog::reject();
}
