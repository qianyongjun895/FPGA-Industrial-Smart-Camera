...
FWP2POffsetLabel::FWP2POffsetLabel(QWidget *parent) : QLabel(parent)
{
    i_learn_result = 0;
 ...
 * @note 设置点一的坐标
 */
void FWP2POffsetLabel::SetPoint1(QPoint point)
{
    m_point1 = point;
    update();
}
 ...
 * @note 设置点二的坐标
 */
void FWP2POffsetLabel::SetPoint2(QPoint point)
{
    m_point2 = point;
    update();
}

void FWP2POffsetLabel::SetSet_Parameter_To_RamFlag(int flag)
{
    i_learn_result = flag;
    update();
}
 ...
 * @note 两点距离的osd绘制函数
 */
void FWP2POffsetLabel::paintEvent(QPaintEvent *e)
{
    QLabel::paintEvent(e);
...
void FWP2POffsetLabel::SetPenColor(void *pen_color)
{
