#ifndef MONOAREAWIDGET_H
#define MONOAREAWIDGET_H
...
namespace Ui {
class MonoAreaWidget;
}

class MonoAreaWidget : public QWidget
{
    Q_OBJECT

public:
    explicit MonoAreaWidget(QWidget *parent = 0);
    ~MonoAreaWidget();
...
private:
    Ui::MonoAreaWidget *ui;
    QLabel *m_label;
    MONO_AREA_INPUT_PARAM *pInputPara;
    ...
    void MonoAreaMinInputPro();
    void MonoAreaMaxInputPro();
    void SetDataToLib();
    void GetDataFromLib();
    void LoadLearnLib();
