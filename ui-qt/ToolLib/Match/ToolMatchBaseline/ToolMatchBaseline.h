#ifndef TOOLMATCHBASELINE_H
#define TOOLMATCHBASELINE_H

#include "toolmatchbaseline_global.h"
#include <QWidget>
#include "../../BasicDefine.h"

class TOOLMATCHBASELINESHARED_EXPORT ToolMatchBaseline
{
