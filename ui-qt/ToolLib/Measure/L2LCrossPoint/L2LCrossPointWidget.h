#ifndef L2LCROSSPOINTWIDGET_H
#define L2LCROSSPOINTWIDGET_H
...
namespace Ui {
class L2LCrossPointWidget;
}

class L2LCrossPointWidget : public QWidget
{
    Q_OBJECT

public:
    explicit L2LCrossPointWidget(QWidget *parent = 0);
    ~L2LCrossPointWidget();
