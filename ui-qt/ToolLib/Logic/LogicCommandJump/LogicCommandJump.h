#ifndef LOGICCOMMANDJUMP_H
#define LOGICCOMMANDJUMP_H

#include "logiccommandjump_global.h"
#include <QWidget>
#include "../../BasicDefine.h"

class LOGICCOMMANDJUMPSHARED_EXPORT LogicCommandJump
{
